...
/*
 * SM2 SM3 signature (GM/T 0003).
 * China's mandated EC signature for banking, e-government, critical infra.
 */
...
benchmark_t bench_crypto_sm2_sign = {
    ...
    .description="SM2 SM3 signature (GM/T 0003, China banking/e-government standard)",
