...
/*
 * SM4 CTR encrypt throughput (Chinese national standard GM/T 0002).
 * Mandated for Chinese financial data encryption, VPN, cloud storage.
 * 128-bit block, 128-bit key. Same structure as crypto_aes.c for comparison.
 */
...
benchmark_t bench_crypto_sm4 = {
    ...
    .description="SM4 CTR encrypt throughput (GM/T 0002, Chinese cipher. 128-bit, cf. AES-128-CTR)",
