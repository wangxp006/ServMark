...
/*
 * SM3 hash throughput (Chinese national standard GM/T 0004).
 * Mandated for Chinese financial integrity verification.
 * 256-bit output, same buffer size as crypto_hash.c for direct comparison.
 */
...
benchmark_t bench_crypto_sm3 = {
    ...
    .description="SM3 hash throughput 256MB (GM/T 0004, Chinese financial standard, cf. SHA-256)",
